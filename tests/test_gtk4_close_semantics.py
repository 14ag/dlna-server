...
def test_stopped_close_destroys_window(gtk4_gui_binary, tmp_path):
    ...
    result = subprocess.run(
        ["dbus-run-session", "--", "xvfb-run", "-a", str(gtk4_gui_binary),
...
def test_log_dialog_reopens_after_close(gtk4_gui_binary, tmp_path):
...
def test_message_box_parents_to_active_dialog(gtk4_gui_binary, tmp_path):
...
def test_delete_disabled_after_focus_leaves_source_list(gtk4_gui_binary, tmp_path):
