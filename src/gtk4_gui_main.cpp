...
void OnAppStartup(GtkApplication* app, gpointer) {
    ...
    const char* dialogCss =
        ...
        "listbox { background-color: rgb(31,31,31); color: rgb(255,255,255); }\n"
        "listbox row { padding: 4px 6px; background-color: rgb(31,31,31); "
        "color: rgb(255,255,255); }\n"
        "listbox row:selected { background-color: rgb(70,90,120); "
        "color: rgb(255,255,255); }\n"
